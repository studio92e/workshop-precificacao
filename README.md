...
Esta pasta é gerada. A fonte que se edita fica no workspace do Studio 92e
(`clientes/soane-figliuolo/copy/lp-v2/landing.html`); `build.py` gera este
`index.html` e copia as imagens.
